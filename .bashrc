...
alias debug='/home/alexander/.config/hypr/scripts/debug.sh'
alias test_pyright="/home/alexander/TestVSCode/pyrightTest.sh"
...
logic_test() {
  local waybar_status="$(pgrep -x "waybar")"
  local randomArgument="false"
  if [[ $randomArgument == "false" || ! $waybar_status ]]; then
    echo True
  else
    echo False
  fi
