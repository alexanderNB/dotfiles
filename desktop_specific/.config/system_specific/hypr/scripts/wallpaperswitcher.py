...
with os.scandir(os.path.expanduser("~") + "/.config/hypr/wallpapers/") as d:
    ...
    while True:
        ...
        os.system(f"hyprctl hyprpaper wallpaper DP-1, ~/.config/hypr/wallpapers/{b}, cover")
        os.system(f"hyprctl hyprpaper wallpaper DP-2, ~/.config/hypr/wallpapers/{c}, cover")
        time.sleep(600)
