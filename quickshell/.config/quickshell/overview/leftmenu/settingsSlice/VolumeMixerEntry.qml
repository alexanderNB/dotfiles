...
Item {
    ...
    property var excludedChannels: ["Raptor Lake-P/U/H cAVS HDMI / DisplayPort 1 Output", "Raptor Lake-P/U/H cAVS HDMI / DisplayPort 2 Output", "Raptor Lake-P/U/H cAVS HDMI / DisplayPort 3 Output"]
    visible: true
