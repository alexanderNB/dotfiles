...
if ! builtin zmodload -e zsh/mapfile; then
    zmodload zsh/mapfile 2>/dev/null \
      || print -u2 "⚠  zsh/mapfile module not available"
fi
# If not running interactively, don't do anything
[[ $- != *i* ]] && return

# Load mapfile so Bash code that uses it works unchanged
...
export FZF_DEFAULT_COMMAND="fd --type f --hidden --exclude Steam --exclude Games"
